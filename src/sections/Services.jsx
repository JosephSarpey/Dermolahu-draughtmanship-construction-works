...
const Services = () => {
  return (
    <div id='services' className='w-full bg-white'>
      ...
      >
        <motion.h1 variants={slideUpVariants} className='text-turquoise text-2xl'>SPECIAL OFFER</motion.h1>
        ...
        >
          {
            allservices.map((item, index) => (
              <motion.div
                ...
                key={index}>
                <img src={item.icon} alt="icon" className='w-[80px] border-2 border-turquoise hover:bg-turquoise rounded-lg p-2' />
