...
const DetailedAbout = () => {
  return (
    <div className="w-full background-color: rgb(45, 42, 42)">
      ...
      <div
        id="about"
        className="w-[90%] m-auto py-[60px] flex lg:flex-row flex-col justify-between items-start gap-[50px] lg:w-[80%]"
      >
        <motion.div
          initial="hidden"
          whileInView="visible"
        ...
        >
          ...
          <p className="text-white text-lg mt-[20px]">
            ...
            commitment to quality, safety, and customer satisfaction. We aspire
            to create lasting impacts on the communities we serve by delivering
        ...
        >
          ...
          <p className="text-white text-lg text-justify mt-[20px]">
            ...
            looking to master architectural and structural design tools. With a
            strong commitment to quality, safety, and customer satisfaction, we
            aim to deliver exceptional building solutions tailored to your
            needs. Whether you're starting a new construction project, need
            expert guidance, or require premium building materials, we are your
      ...
      <div className="lg:w-[80%] w-[90%] m-auto py-[60px]">
        ...
        <p className="text-white text-lg text-justify">
          To be the leading provider of innovative and sustainable construction
          solutions, transforming the built environment with excellence and
          integrity.
        </p>
      </div>
      ...
      <div className="lg:w-[80%] w-[90%] m-auto py-[60px]">
        ...
        <p className="text-white text-lg text-justify">
          Our goals are to exceed client expectations through our commitment to
          quality, safety, and customer satisfaction. We aim to create lasting
          impacts on the communities we serve by delivering exceptional building
      ...
      <div className="lg:w-[80%] w-[90%] m-auto py-[60px]">
        ...
        <p className="text-white text-lg text-justify">
          ...
          innovate and excel in every project, ensuring our clients' visions are
        ...
        >
          ...
          >
            {planning.map((item, index) => (
              <div
                key={index}
                className="flex flex-col justify-center items-center gap-5 border-2 border-turquoise rounded-mg p-6"
              >
                <div>
      ...
      <div className="lg:w-[80%] w-[90%] m-auto py-[60px]">
        <h2 className="text-white text-3xl font-bold mb-[40px]">
          Meet Our Team
        </h2>
