...
const Testimonials = () => {
  return (
    <div id='clients' className='w-full'>
      ...
      >
        <motion.h1 variants={slideUpVariants} className='text-turquoise text-2xl'>TESTIMONIALS</motion.h1>
        ...
        >
      {
        clients.map((item, index) => (
          <div key={index} className='flex flex-col justify-center items-center'>
            <div className='border-2 border-white hover:bg-turquoise pb-[100px] pt-[30px]'>
            ...
            <div className='flex flex-col justify-center items-center gap-[5px]'>
              ...
              <h1 className='text-turquoise text-[22px]'>{item.post}</h1>
            </div>
