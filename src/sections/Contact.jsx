...
const Contact = () => {
  return (
    <div id='contact' className='bg-white w0full'>
      <div className='lg:w-[80%] w-[90%] m-auto py-[60px] flex lg:flex-row flex-col justify-between items-start gap-[50px]' id='about'>
         ...
         >
           ...
           <p className='text-3xl italic text-gray-600 mt-[60px]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Esse, sequi.</p>
         </motion.div>
